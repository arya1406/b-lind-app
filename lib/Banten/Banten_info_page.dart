...
class BantenInfoPage extends StatefulWidget {
  @override
  _BantenInfoPageState createState() => _BantenInfoPageState();
}

class _BantenInfoPageState extends State<BantenInfoPage> {
  @override
